...
#include "Assets/SGSSS/ShaderLibrary/Core.hlsl"
#include "Assets/SGSSS/ShaderLibrary/CommonMaterial.hlsl"
#include "Assets/SGSSS/ShaderLibrary/SurfaceInput.hlsl"
#include "Assets/SGSSS/ShaderLibrary/ParallaxMapping.hlsl"
...
half4 SampleMetallicSpecGloss2(float2 uv, half albedoAlpha)
{
    ...
    specGloss = half4(SAMPLE_METALLICSPECULAR(uv));
    #ifdef _SMOOTHNESS_TEXTURE_ALBEDO_CHANNEL_A
    specGloss.a = albedoAlpha * _Smoothness2;
    #else
    specGloss.a *= _Smoothness2;
    #endif
    #else // _METALLICSPECGLOSSMAP
    #if _SPECULAR_SETUP
    specGloss.rgb = _SpecColor.rgb;
...
inline void InitializeStandardLitSurfaceData(float2 uv, out SurfaceData outSurfaceData)
{
    ...
    outSurfaceData.curvature = SAMPLE_TEXTURE2D(_Curvature, sampler_Curvature, uv).r;
